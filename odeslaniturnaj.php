...
if (mail("skokan440@seznam.cz","Registrace do turnaje na www.w3server.wz.cz",$message))
{echo "Dìkujeme vám že ste se pøidali do turnaje a pøejeme vám mnoho vyhraných zápasù.<br><br>Pokud jste zadali e-mail, pøijde vám na nìj potvrzení o registraci.<br><br>";}
else {echo "Dohužel se vám formuláø nepodaøilo odeslat, zkuste to prosím znovu.<br><br>";}

$message2 = "Dìkujeme vám že ste se pøidali do turnaje a pøejeme vám mnoho vyhraných zápasù.".
	         ...
	         "\nPøíjemnou zábavu na http://www.w3server.wz.cz vám pøejí *Tony440*, *Fenix* a *Werzo*";

if ($msg4=="@"){}
   else if ($msg4==""){}
            else {mail($msg4,"Žádost o èlenství na www.w3server.wz.cz",$message2);}


$filename="turnaj_tabulka.php";

if ($msg1=="") {$msg1=".&nbsp;.&nbsp;.";}
if ($msg2=="") {$msg2=".&nbsp;.&nbsp;.";}
if ($msg3=="xxx-xxx-xxx") {$msg3=".&nbsp;.&nbsp;.";}
if ($msg3=="") {$msg3=".&nbsp;.&nbsp;.";}
if ($msg4=="") {$msg4=".&nbsp;.&nbsp;.";} else if ($msg4=="@") {$msg4=".&nbsp;.&nbsp;.";}
