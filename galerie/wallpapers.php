...
<table width="800px" border="0" cellspacing="0" cellpadding="0" bordercolor="#ffffff" background="galerie_soubory/pozadi.gif" >
  ...
  <tr>
    <td align="center">
      <img src="<? echo "wallpapers/wallpaper".$o.".jpg" ?>" width="750px" height="563px">
    </td>
  </tr>
  <tr>
    <td height="15px"></td>
            ...
            <table width="150px" border="0" cellspacing="0" cellpadding="0" bordercolor="#ffffff">
              <tr>
                <td background="galerie_soubory/polozka_menu.gif" width="150px" height="32px" align="center">
                  <a href="wallpapers.php?o=<? if ($o=="1"){echo "1";} else {$b=$o-1; echo  $b;} ?>"><<< Předchozí</a>
                </td>
              </tr>
            </table>
          </td>
          <td align="left">
            <img src="<? $z=$o-1; echo "wallpapers_nahled/wallpaper".$z."_nahled.jpg" ?>" width="80px" height="64px">
          </td>
          <td align="center" class="pocet">
            <?
            echo "Wallpaper ".$o." z ".$max;
            ?>
    		</td>
    	  <td align="right">
      		<img src="<? $v=$o+1; echo "wallpapers_nahled/wallpaper".$v."_nahled.jpg" ?>" width="80px" height="64px">
    	  </td>
    	  <td width="80px" align="right" valign="middle">
    	  	<table width="150px" border="0" cellspacing="0" cellpadding="0" bordercolor="#ffffff">
              <tr>
                <td background="galerie_soubory/polozka_menu.gif" width="150px" height="32px" align="center">
      		       <a href="wallpapers.php?o=<? if ($o==$max){echo $max;} else {$b=$o+1; echo  $b;} ?>">Následující >>></a>
    	        </td>
              </tr>
            </table>
    	  </td>
